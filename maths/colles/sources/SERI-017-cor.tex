...
\item $(v_n)$ est décroissante à partir de $n\ge 1$ seulement. En effet, $v_0<v_1$ et on a
\[
v_{n+1}-v_n
...
\]
\end{itemize}
Ainsi, $(u_n)$ est strictement croissante, $(v_n)$ est strictement décroissante et $v_n-u_n\tend0$ :
...
\]
D’un autre côté, $(u_n)$ est strictement croissante, $(v_n)$ est strictement décroissante et les suites sont adjacentes donc $\ell\in]u_q,v_q[$. Ainsi
\[
