% CCP 2023 exo 98
Un secrétaire effectue, une première fois, un appel téléphonique vers $n$ correspondants distincts.\\
...
\item
Le secrétaire rappelle une seconde fois, dans les mêmes conditions, chacun des $n-X$ correspondants qu'il n'a pas pu joindre au cours de la première série d'appels.
