...
l'épreuve de l'appel téléphonique du secrétaire vers un correspondant est répétée $n$ fois et ces $n$ épreuves sont  mutuellement indépendantes.\\
...
ou le correspondant n'est pas joint avec la probabilité $1-p$ (échec).\\
 ...
 Sous la condition $(X=i)$, le secrétaire rappelle $n-i$ correspondants lors de la seconde série d'appels.
